...
fn bench_alacritty_processing() {
    ...
    println!("Alacritty per iteration: {:?}", alacritty_duration / iterations);
}
...
fn bench_alacritty_chunked_processing() {
    ...
    println!("Alacritty chunked per iteration: {:?}", alacritty_chunked_duration / iterations);
}
...
fn bench_grid_reading_comparison() {
    ...
    for _ in 0..iterations {
        ...
        for row in 0..30 {
            for col in 0..80 {
                ...
                black_box(cell.fg);
                black_box(cell.bg);
                black_box(cell.flags.contains(alacritty_terminal::term::cell::Flags::BOLD));
            }
        }
    }
    ...
    println!("VT100 vs Alacritty direct: {:.2}x", alacritty_direct_time.as_nanos() as f64 / vt100_read_time.as_nanos() as f64);
    println!("VT100 vs Alacritty display_iter: {:.2}x", alacritty_iter_time.as_nanos() as f64 / vt100_read_time.as_nanos() as f64);
    println!("Alacritty direct vs display_iter: {:.2}x", alacritty_iter_time.as_nanos() as f64 / alacritty_direct_time.as_nanos() as f64);
}