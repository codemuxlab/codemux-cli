	...
	if (error) {
		return (
			<View className="flex-1 bg-background p-4">
				...
				>
					<Text className="text-foreground text-center">Retry</Text>
				</TouchableOpacity>
			</View>
		);
	}
		...
		<View className="flex-1 bg-background">
			...
			<View className="bg-card p-3 border-b border-border">
				<View className="flex-row items-center justify-between">
					...
					>
						<Text className="text-foreground text-xs">🔄 Refresh</Text>
					</TouchableOpacity>
				</View>
			</View>
			...
			<View className="flex-1 flex-row">
				{/* File list sidebar */}
				<View className="w-1/3 bg-card border-r border-border">
							...
							>
								<View className="flex-row items-center">
									...
									<View className="flex-1">
										<Text className="text-foreground text-sm font-mono truncate">
											{file.path}
										</Text>
